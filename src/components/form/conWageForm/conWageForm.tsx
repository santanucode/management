...
import { ADDNEWLABEL, UPDATELABEL, SAVEBTN, UPDATEBTN, DATEERROR, DATELABEL, DATEPLACEHOLDER, CANCELBTN, WAGEPLACEHOLDER, WAGELABEL, WAGEERROR } from './conWageString';
import "../style.scss"

const ConWageForm = (props: FormProps) => {
    const {
        initialValue = {},
        handleFormData,
        onHandleClose,
