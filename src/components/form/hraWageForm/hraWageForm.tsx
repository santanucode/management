...
import { ADDNEWLABEL, UPDATELABEL, SAVEBTN, UPDATEBTN, DATEERROR, DATELABEL, DATEPLACEHOLDER, CANCELBTN, WAGEPLACEHOLDER, WAGELABEL, WAGEERROR } from './hraWageString';
import "../style.scss"

const HRAWageForm = (props: FormProps) => {
    const {
        initialValue = {},
        handleFormData,
        onHandleClose,
