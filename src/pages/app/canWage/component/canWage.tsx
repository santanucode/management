...
import { ADDNEWWAGE, CURRENTPATH, EFFECTDATELABEL, HOMEPATH, TBLHEAD, BASICAMOUNTLABEL } from '../container/canWageString';
import DataTable from 'components/table/dataTable/dataTable';
import CommonMainButton from 'components/common/Button/commonButton';
import ConWageForm from 'components/form/conWageForm/conWageForm';
